(function () {
  ...
  function getClosestMatch(e, t) {
    for (; e && !t(e); ) e = parentElt(e);
    return e || null;
  }
  function getAttributeValueWithDisinheritance(e, t, n) {
    const r = getAttributeValue(t, n),
      o = getAttributeValue(t, "hx-disinherit");
    var i = getAttributeValue(t, "hx-inherit");
    if (e !== t) {
      if (htmx.config.disableInheritance) return i && (i === "*" || i.split(" ").indexOf(n) >= 0) ? r : null;
  ...
  function takeChildrenFor(e, t) {
    for (; t.childNodes.length > 0; ) e.append(t.childNodes[0]);
  }
  function duplicateScript(e) {
    ...
    return (
      ...
      (t.async = !1),
      htmx.config.inlineScriptNonce && (t.nonce = htmx.config.inlineScriptNonce),
      t
    );
  }
  ...
  function normalizeScriptTags(e) {
    Array.from(e.querySelectorAll("script")).forEach((t) => {
      if (isJavaScriptScriptNode(t)) {
        const n = duplicateScript(t),
          r = t.parentNode;
        try {
          r.insertBefore(n, t);
        } catch (o) {
  ...
  function makeFragment(e) {
    ...
    if (n === "html") {
      ...
      (r = i.querySelector("template").content), (r.title = i.title);
    ...
    return (
      r &&
        (htmx.config.allowScriptTags
          ...
          : r.querySelectorAll("script").forEach((i) => i.remove())),
      r
    );
  }
  ...
  function forEach(e, t) {
    if (e) for (let n = 0; n < e.length; n++) t(e[n]);
  }
  ...
  function onLoadHelper(e) {
    return htmx.on("htmx:load", function (n) {
      e(n.detail.elt);
    });
  }
  function logAll() {
  ...
  function removeClassFromElement(e, t, n) {
    ...
    r &&
      (n
        ...
        : r.classList && (r.classList.remove(t), r.classList.length === 0 && r.removeAttribute("class")));
  }
  ...
  function takeClassForElement(e, t) {
    (e = resolveTarget(e)),
      forEach(e.parentElement.children, function (n) {
  ...
  function querySelectorAllExt(e, t, n) {
    if (t.indexOf("global ") === 0) return querySelectorAllExt(e, t.slice(7), !0);
    e = resolveTarget(e);
    const r = [];
    {
      let s = 0,
      ...
      for (let l = 0; l < t.length; l++) {
        const u = t[l];
        if (u === "," && s === 0) {
          r.push(t.substring(a, l)), (a = l + 1);
          continue;
        }
        u === "<" ? s++ : u === "/" && l < t.length - 1 && t[l + 1] === ">" && s--;
      }
      a < t.length && r.push(t.substring(a));
    }
    const o = [],
      i = [];
    for (; r.length > 0; ) {
      ...
      let a;
      s.indexOf("closest ") === 0
        ? (a = closest(asElement(e), normalizeSelector(s.slice(8))))
        : s.indexOf("find ") === 0
          ? (a = find(asParentNode(e), normalizeSelector(s.slice(5))))
          : s === "next" || s === "nextElementSibling"
            ? (a = asElement(e).nextElementSibling)
            : s.indexOf("next ") === 0
              ? (a = scanForwardQuery(e, normalizeSelector(s.slice(5)), !!n))
              : s === "previous" || s === "previousElementSibling"
                ? (a = asElement(e).previousElementSibling)
                : s.indexOf("previous ") === 0
                  ? (a = scanBackwardsQuery(e, normalizeSelector(s.slice(9)), !!n))
                  : s === "document"
                    ? (a = document)
                    : s === "window"
                      ? (a = window)
                      : s === "body"
                        ...
                        : s === "root"
                          ? (a = getRootNode(e, !!n))
                          : s === "host"
                            ? (a = e.getRootNode().host)
                            : i.push(s),
        a && o.push(a);
    }
    if (i.length > 0) {
      const s = i.join(","),
        a = asParentNode(getRootNode(e, !!n));
      o.push(...toArray(a.querySelectorAll(s)));
    }
    return o;
  }
  ...
  function processEventArgs(e, t, n, r) {
    return isFunction(t)
      ? { target: getDocument().body, event: asString(e), listener: t, options: n }
      : { target: resolveTarget(e), event: asString(t), listener: n, options: r };
  }
  ...
  function findAttributeTargets(e, t) {
    ...
    if (n) {
      if (n === "this") return [findThisElement(e, t)];
      {
        const r = querySelectorAllExt(e, n);
        if (/(^|,)(\s*)inherit(\s*)($|,)/.test(n)) {
          const i = asElement(
            getClosestMatch(e, function (s) {
        ...
        return r.length === 0
          ? (logError('The selector "' + n + '" on ' + t + " returned no matches!"), [DUMMY_ELT])
          : r;
      }
    }
  }
  ...
  function getTarget(e) {
    ...
    return t
      ? t === "this"
        ? findThisElement(e, "hx-target")
        : querySelectorExt(e, t)
      : getInternalData(e).boosted
        ? getDocument().body
        : e;
  }
  ...
  function oobSwap(e, t, n, r) {
    r = r || getDocument();
    let o = "#" + CSS.escape(getRawAttribute(t, "id")),
      i = "outerHTML";
    e === "true" ||
      (e.indexOf(":") > 0 ? ((i = e.substring(0, e.indexOf(":"))), (o = e.substring(e.indexOf(":") + 1))) : (i = e)),
      t.removeAttribute("hx-swap-oob"),
      t.removeAttribute("data-hx-swap-oob");
    ...
    return (
      s.length
        ? (forEach(s, function (a) {
            ...
            (l = getDocument().createDocumentFragment()), l.appendChild(u), isInlineSwap(i, a) || (l = asParentNode(u));
            const h = { shouldSwap: !0, target: a, fragment: l };
            triggerEvent(a, "htmx:oobBeforeSwap", h) &&
              ((a = h.target),
              h.shouldSwap && (handlePreservedElements(l), swapWithStyle(i, a, a, l, n), restorePreservedElements()),
              forEach(n.elts, function (c) {
                triggerEvent(c, "htmx:oobAfterSwap", h);
              }));
          }),
          t.parentNode.removeChild(t))
        : (t.parentNode.removeChild(t), triggerErrorEvent(getDocument().body, "htmx:oobErrorNoTarget", { content: t })),
      e
    );
  }
  ...
  function handlePreservedElements(e) {
    forEach(findAll(e, "[hx-preserve], [data-hx-preserve]"), function (t) {
      const n = getAttributeValue(t, "id"),
        r = getDocument().getElementById(n);
      if (r != null)
        if (t.moveBefore) {
          let o = find("#--htmx-preserve-pantry--");
          o == null &&
            (getDocument().body.insertAdjacentHTML("afterend", "<div id='--htmx-preserve-pantry--'></div>"),
            (o = find("#--htmx-preserve-pantry--"))),
            o.moveBefore(r, null);
  ...
  function processFocus(e) {
    const t = "[autofocus]",
      n = asHtmlElement(matches(e, t) ? e : e.querySelector(t));
    n != null && n.focus();
  }
  function insertNodesBefore(e, t, n, r) {
    for (handleAttributes(e, n, r); n.childNodes.length > 0; ) {
      const o = n.firstChild;
      addClassToElement(asElement(o), htmx.config.addedClass),
        e.insertBefore(o, t),
        o.nodeType !== Node.TEXT_NODE && o.nodeType !== Node.COMMENT_NODE && r.tasks.push(makeAjaxLoadTask(o));
    }
  }
  function stringHash(e, t) {
    let n = 0;
    for (; n < e.length; ) t = ((t << 5) - t + e.charCodeAt(n++)) | 0;
    return t;
  }
  ...
  function deInitNode(e) {
    ...
    t.timeout && clearTimeout(t.timeout),
      t.listenerInfos &&
        forEach(t.listenerInfos, function (n) {
          n.on && removeEventListenerImpl(n.on, n.trigger, n.listener);
        }),
      deInitOnHandlers(e),
      forEach(Object.keys(t), function (n) {
  ...
  function cleanUpElement(e) {
    triggerEvent(e, "htmx:beforeCleanupElement"),
      deInitNode(e),
      forEach(e.children, function (t) {
        cleanUpElement(t);
      });
  }
  function swapOuterHTML(e, t, n) {
    if (e.tagName === "BODY") return swapInnerHTML(e, t, n);
    let r;
    const o = e.previousSibling,
      i = parentElt(e);
    if (i) {
      for (
        insertNodesBefore(i, e, t, n),
          o == null ? (r = i.firstChild) : (r = o.nextSibling),
          n.elts = n.elts.filter(function (s) {
            return s !== e;
          });
        r && r !== e;
      )
  ...
  function swapInnerHTML(e, t, n) {
    ...
    if ((insertNodesBefore(e, r, t, n), r)) {
      for (; r.nextSibling; ) cleanUpElement(r.nextSibling), e.removeChild(r.nextSibling);
              ...
              if (Array.isArray(l))
                for (let u = 0; u < l.length; u++) {
                  ...
                  h.nodeType !== Node.TEXT_NODE &&
                    ...
                    o.tasks.push(makeAjaxLoadTask(h));
                }
              return;
            }
          } catch (l) {
  ...
  function findAndSwapOobElements(e, t, n) {
    ...
    return (
      forEach(r, function (o) {
        ...
        } else o.removeAttribute("hx-swap-oob"), o.removeAttribute("data-hx-swap-oob");
      }),
      r.length > 0
    );
  }
  function swap(e, t, n, r) {
    ...
    let o = null,
      ...
      s = function () {
        ...
        const u = r.contextElement ? getRootNode(r.contextElement, !1) : getDocument(),
          h = document.activeElement;
        let c = {};
        c = { elt: h, start: h ? h.selectionStart : null, end: h ? h.selectionEnd : null };
        const f = makeSettleInfo(e);
        if (n.swapStyle === "textContent") e.textContent = t;
        else {
          let d = makeFragment(t);
          if (
            ((f.title = r.title || d.title),
            r.historyRequest && (d = d.querySelector("[hx-history-elt],[data-hx-history-elt]") || d),
            r.selectOOB)
          ) {
          ...
          if (
            (findAndSwapOobElements(d, f, u),
            forEach(findAll(d, "template"), function (E) {
        ...
        if (c.elt && !bodyContains(c.elt) && getRawAttribute(c.elt, "id")) {
          const d = document.getElementById(getRawAttribute(c.elt, "id")),
            E = { preventScroll: n.focusScroll !== void 0 ? !n.focusScroll : !htmx.config.defaultFocusScroll };
          if (d) {
        ...
        e.classList.remove(htmx.config.swappingClass),
          ...
          maybeCall(r.afterSwapCallback),
          n.ignoreTitle || handleTitle(f.title);
        const y = function () {
          if (
            (forEach(f.tasks, function (d) {
              d.call();
            }),
            forEach(f.elts, function (d) {
              d.classList && d.classList.remove(htmx.config.settlingClass),
                triggerEvent(d, "htmx:afterSettle", r.eventInfo);
            }),
            r.anchor)
          ) {
    ...
    n.hasOwnProperty("transition") && (a = n.transition);
    const l = r.contextElement || getDocument();
    if (
      a &&
      triggerEvent(l, "htmx:beforeTransition", r.eventInfo) &&
      typeof Promise < "u" &&
    ...
    try {
      ...
      throw (triggerErrorEvent(l, "htmx:swapError", r.eventInfo), maybeCall(i), u);
    }
  }
  function handleTriggerHeader(e, t, n) {
    ...
    if (r.indexOf("{") === 0) {
      ...
      const o = r.split(",");
      for (let i = 0; i < o.length; i++) triggerEvent(n, o[i].trim(), []);
    }
  }
  ...
  function tokenizeString(e) {
    ...
    for (; n < e.length; ) {
      if (SYMBOL_START.exec(e.charAt(n))) {
        for (var r = n; SYMBOL_CONT.exec(e.charAt(n + 1)); ) n++;
        t.push(e.substring(r, n + 1));
      } else if (STRINGISH_START.indexOf(e.charAt(n)) !== -1) {
        const o = e.charAt(n);
        var r = n;
        for (n++; n < e.length && e.charAt(n) !== o; ) e.charAt(n) === "\\" && n++, n++;
        t.push(e.substring(r, n + 1));
      } else {
        const o = e.charAt(n);
        t.push(o);
        ...
        if (s === "]") {
          if ((r--, r === 0)) {
            ...
            try {
              ...
              return triggerErrorEvent(getDocument().body, "htmx:syntax:error", { error: a, source: o }), null;
            }
          }
        } else s === "[" && r++;
        isPossibleRelativeReference(s, i, n)
          ? (o += "((" + n + "." + s + ") ? (" + n + "." + s + ") : (window." + s + "))")
          : (o = o + s),
          (i = t.shift());
      }
  ...
  function consumeUntil(e, t) {
    let n = "";
    for (; e.length > 0 && !t.test(e[0]); ) n += e.shift();
    return n;
  }
  function consumeCSSSelector(e) {
    let t;
    return (
      e.length > 0 && COMBINED_SELECTOR_START.test(e[0])
        ? (e.shift(), (t = consumeUntil(e, COMBINED_SELECTOR_END).trim()), e.shift())
    ...
    do {
      ...
      if (l !== "")
        if (l === "every") {
          ...
          consumeUntil(o, NOT_WHITESPACE),
            (u.pollInterval = parseInterval(consumeUntil(o, /[,\[\s]/))),
            consumeUntil(o, NOT_WHITESPACE);
          ...
          for (i && (u.eventFilter = i), consumeUntil(o, NOT_WHITESPACE); o.length > 0 && o[0] !== ","; ) {
            const c = o.shift();
            if (c === "changed") u.changed = !0;
            else if (c === "once") u.once = !0;
            else if (c === "consume") u.consume = !0;
            else if (c === "delay" && o[0] === ":")
              o.shift(), (u.delay = parseInterval(consumeUntil(o, WHITESPACE_OR_COMMA)));
            else if (c === "from" && o[0] === ":") {
              if ((o.shift(), COMBINED_SELECTOR_START.test(o[0]))) var s = consumeCSSSelector(o);
              else {
              ...
              c === "target" && o[0] === ":"
                ? (o.shift(), (u.target = consumeCSSSelector(o)))
                : c === "throttle" && o[0] === ":"
                  ? (o.shift(), (u.throttle = parseInterval(consumeUntil(o, WHITESPACE_OR_COMMA))))
                  : c === "queue" && o[0] === ":"
                    ? (o.shift(), (u.queue = consumeUntil(o, WHITESPACE_OR_COMMA)))
                    : c === "root" && o[0] === ":"
                      ? (o.shift(), (u[c] = consumeCSSSelector(o)))
                      : c === "threshold" && o[0] === ":"
                        ? (o.shift(), (u[c] = consumeUntil(o, WHITESPACE_OR_COMMA)))
                        : triggerErrorEvent(e, "htmx:syntax:error", { token: o.shift() });
            consumeUntil(o, NOT_WHITESPACE);
          }
          r.push(u);
        }
      o.length === a && triggerErrorEvent(e, "htmx:syntax:error", { token: o.shift() }),
        consumeUntil(o, NOT_WHITESPACE);
    } while (o[0] === "," && o.shift());
    return n && (n[t] = r), r;
  }
  function getTriggerSpecs(e) {
    ...
    return n.length > 0
      ...
      : matches(e, "form")
        ? [{ trigger: "submit" }]
        : matches(e, 'input[type="button"], input[type="submit"]')
          ? [{ trigger: "click" }]
  ...
  function processPolling(e, t, n) {
    ...
    r.timeout = getWindow().setTimeout(function () {
      bodyContains(e) &&
        r.cancelled !== !0 &&
        (maybeFilterEvent(n, e, makeEvent("hx:poll:trigger", { triggerSpec: n, target: e })) || t(e),
        processPolling(e, t, n));
    }, n.pollInterval);
  }
  function isLocalLink(e) {
    return (
      location.hostname === e.hostname && getRawAttribute(e, "href") && getRawAttribute(e, "href").indexOf("#") !== 0
    );
  }
  ...
  function boostElement(e, t, n) {
    if (
      (e instanceof HTMLAnchorElement && isLocalLink(e) && (e.target === "" || e.target === "_self")) ||
      (e.tagName === "FORM" && String(getRawAttribute(e, "method")).toLowerCase() !== "dialog")
    ) {
      t.boosted = !0;
      let r, o;
      if (e.tagName === "A") (r = "get"), (o = getRawAttribute(e, "href"));
      else {
        const i = getRawAttribute(e, "method");
        (r = i ? i.toLowerCase() : "get"),
          (o = getRawAttribute(e, "action")),
          (o == null || o === "") && (o = location.href),
          r === "get" && o.includes("?") && (o = o.replace(/\?[^#]+/, ""));
      }
  ...
  function shouldCancel(e, t) {
    if (e.type === "submit" && t.tagName === "FORM") return !0;
    if (e.type === "click") {
      const n = t.closest('input[type="submit"], button');
      if (n && n.form && n.type === "submit") return !0;
      const r = t.closest("a"),
        o = /^#.+/;
      if (r && r.href && !o.test(r.getAttribute("href"))) return !0;
    }
    return !1;
  }
  function ignoreBoostedAnchorCtrlClick(e, t) {
    return (
      getInternalData(e).boosted && e instanceof HTMLAnchorElement && t.type === "click" && (t.ctrlKey || t.metaKey)
    );
  }
  ...
  function addEventListener(e, t, n, r, o) {
    ...
    let s;
    r.from ? (s = querySelectorAllExt(e, r.from)) : (s = [e]),
      r.changed &&
        ("lastValue" in i || (i.lastValue = new WeakMap()),
        s.forEach(function (a) {
          i.lastValue.has(r) || i.lastValue.set(r, new WeakMap()), i.lastValue.get(r).set(a, a.value);
        })),
      forEach(s, function (a) {
        const l = function (u) {
          if (!bodyContains(e)) {
            a.removeEventListener(r.trigger, l);
            return;
          }
          if (
            ignoreBoostedAnchorCtrlClick(e, u) ||
            ((o || shouldCancel(u, a)) && u.preventDefault(), maybeFilterEvent(r, e, u))
          )
            return;
          ...
          if (((h.triggerSpec = r), h.handledFor == null && (h.handledFor = []), h.handledFor.indexOf(e) < 0)) {
            if (
              (h.handledFor.push(e),
              r.consume && u.stopPropagation(),
              r.target && u.target && !matches(asElement(u.target), r.target))
            )
              return;
            if (r.once) {
              if (i.triggeredOnce) return;
              i.triggeredOnce = !0;
            }
            if (r.changed) {
              const c = u.target,
                f = c.value,
                y = i.lastValue.get(r);
              if (y.has(c) && y.get(c) === f) return;
              y.set(c, f);
            }
            if ((i.delayed && clearTimeout(i.delayed), i.throttle)) return;
            r.throttle > 0
              ? i.throttle ||
                (triggerEvent(e, "htmx:trigger"),
                t(e, u),
                (i.throttle = getWindow().setTimeout(function () {
                  i.throttle = null;
                }, r.throttle)))
              : r.delay > 0
                ? (i.delayed = getWindow().setTimeout(function () {
                    triggerEvent(e, "htmx:trigger"), t(e, u);
                  }, r.delay))
                : (triggerEvent(e, "htmx:trigger"), t(e, u));
          }
        };
        n.listenerInfos == null && (n.listenerInfos = []),
          n.listenerInfos.push({ trigger: r.trigger, listener: l, on: a }),
          a.addEventListener(r.trigger, l);
      });
  }
    ...
    scrollHandler ||
      ...
      setInterval(function () {
        windowIsScrolling &&
          ((windowIsScrolling = !1),
          forEach(
            getDocument().querySelectorAll("[hx-trigger*='revealed'],[data-hx-trigger*='revealed']"),
            function (e) {
              maybeReveal(e);
            },
          ));
  ...
  function maybeReveal(e) {
    !hasAttribute(e, "data-hx-revealed") &&
      isScrolledIntoView(e) &&
      (e.setAttribute("data-hx-revealed", "true"),
      getInternalData(e).initHash
        ...
        if (hasAttribute(e, "hx-" + o)) {
          ...
          (r = !0),
            ...
            n.forEach(function (s) {
              addTriggerHandler(e, s, t, function (a, l) {
                const u = asElement(a);
                if (eltIsDisabled(u)) {
                  cleanUpElement(u);
                  return;
                }
                issueAjaxRequest(o, i, u, l);
              });
            });
        }
      }),
  ...
  function addTriggerHandler(e, t, n, r) {
    if (t.trigger === "revealed") initScrollHandler(), addEventListener(e, r, n, t), maybeReveal(asElement(e));
    else if (t.trigger === "intersect") {
      const o = {};
      t.root && (o.root = querySelectorExt(e, t.root)),
        t.threshold && (o.threshold = parseFloat(t.threshold)),
        new IntersectionObserver(function (s) {
          for (let a = 0; a < s.length; a++)
            if (s[a].isIntersecting) {
              triggerEvent(e, "intersect");
              break;
            }
        }, o).observe(asElement(e)),
        addEventListener(asElement(e), r, n, t);
    } else
      !n.firstInitCompleted && t.trigger === "load"
        ? maybeFilterEvent(t, e, makeEvent("load", { elt: e })) || loadImmediately(asElement(e), r, n, t.delay)
        : t.pollInterval > 0
          ? ((n.polling = !0), processPolling(asElement(e), r, t))
  ...
  function findHxOnWildcardElements(e) {
    const t = [];
    if (e instanceof DocumentFragment) for (const n of e.childNodes) processHXOnRoot(n, t);
    else processHXOnRoot(e, t);
    return t;
  }
      ...
      if (startsWith(n, "hx-on") || startsWith(n, "data-hx-on")) {
        ...
        if (i === "-" || i === ":") {
          ...
          startsWith(s, ":")
            ...
            : startsWith(s, "-")
              ? (s = "htmx:" + s.slice(1))
              : startsWith(s, "htmx-") && (s = "htmx:" + s.slice(5)),
            addHxOnEventHandler(e, s, r);
        }
      }
    }
  }
  function initNode(e) {
    ...
    const t = getInternalData(e),
      n = getTriggerSpecs(e);
    processVerbs(e, t, n) ||
      (getClosestAttributeValue(e, "hx-boost") === "true"
        ? boostElement(e, t, n)
        : hasAttribute(e, "hx-trigger") &&
          n.forEach(function (o) {
            addTriggerHandler(e, o, t, function () {});
          })),
      (e.tagName === "FORM" || (getRawAttribute(e, "type") === "submit" && hasAttribute(e, "form"))) &&
        initButtonTracking(e),
      (t.firstInitCompleted = !0),
      triggerEvent(e, "htmx:afterProcessNode");
  }
  ...
  function processNode(e) {
    ...
    const t = [];
    maybeDeInitAndHash(e) && t.push(e),
      forEach(findElementsToProcess(e), function (n) {
        if (eltIsDisabled(n)) {
          cleanUpElement(n);
          return;
        }
  ...
  function triggerEvent(e, t, n) {
    ...
    htmx.logger && !ignoreEventForLogging(t) && htmx.logger(e, t, n),
      n.error && (logError(n.error), triggerEvent(e, "htmx:error", { errorInfo: n }));
    ...
    return (
      withExtensions(asElement(e), function (s) {
  ...
  function saveToHistoryCache(e, t) {
    ...
    const n = cleanInnerHtmlForHistory(t),
      r = getDocument().title,
      o = window.scrollY;
    ...
    for (
      triggerEvent(getDocument().body, "htmx:historyItemCreated", { item: s, cache: i }), i.push(s);
      i.length > htmx.config.historyCacheSize;
    )
      i.shift();
    for (; i.length > 0; )
      try {
        ...
        triggerErrorEvent(getDocument().body, "htmx:historyCacheError", { cause: a, cache: i }), i.shift();
      }
  }
  function getCachedHistory(e) {
    ...
    for (let n = 0; n < t.length; n++) if (t[n].url === e) return t[n];
    return null;
  }
  function cleanInnerHtmlForHistory(e) {
    const t = htmx.config.requestClass,
      n = e.cloneNode(!0);
    return (
      forEach(findAll(n, "." + t), function (r) {
  ...
  function saveCurrentPageToHistory() {
    ...
    canAccessLocalStorage() && (t = sessionStorage.getItem("htmx-current-path-for-history")),
      (t = t || location.pathname + location.search),
      getDocument().querySelector('[hx-history="false" i],[data-hx-history="false" i]') ||
        (triggerEvent(getDocument().body, "htmx:beforeHistorySave", { path: t, historyElt: e }),
        saveToHistoryCache(t, e)),
      htmx.config.historyEnabled && history.replaceState({ htmx: !0 }, getDocument().title, location.href);
  }
  function pushUrlIntoHistory(e) {
    htmx.config.getCacheBusterParam &&
      ((e = e.replace(/org\.htmx\.cache-buster=[^&]*&?/, "")),
      (endsWith(e, "&") || endsWith(e, "?")) && (e = e.slice(0, -1))),
      htmx.config.historyEnabled && history.pushState({ htmx: !0 }, "", e),
      setCurrentPathForHistory(e);
  }
  ...
  function loadHistoryFromServer(e) {
    const t = new XMLHttpRequest(),
      n = { swapStyle: "innerHTML", swapDelay: 0, settleDelay: 0 },
      r = { path: e, xhr: t, historyElt: getHistoryElement(), swapSpec: n };
    t.open("GET", e, !0),
      htmx.config.historyRestoreAsHxRequest && t.setRequestHeader("HX-Request", "true"),
      ...
      (t.onload = function () {
        this.status >= 200 && this.status < 400
          ? ((r.response = this.response),
            ...
            swap(r.historyElt, r.response, n, { contextElement: r.historyElt, historyRequest: !0 }),
            setCurrentPathForHistory(r.path),
  ...
  function restoreHistory(e) {
    ...
    if (t) {
      const n = { swapStyle: "innerHTML", swapDelay: 0, settleDelay: 0, scroll: t.scroll },
        r = { path: e, item: t, historyElt: getHistoryElement(), swapSpec: n };
      triggerEvent(getDocument().body, "htmx:historyCacheHit", r) &&
        (swap(r.historyElt, t.content, n, { contextElement: r.historyElt, title: t.title }),
        setCurrentPathForHistory(r.path),
        triggerEvent(getDocument().body, "htmx:historyRestore", r));
    } else htmx.config.refreshOnHistoryMiss ? htmx.location.reload(!0) : loadHistoryFromServer(e);
  }
  ...
  function disableElements(e) {
    ...
    return (
      ...
      forEach(t, function (n) {
        const r = getInternalData(n);
        (r.requestCount = (r.requestCount || 0) + 1),
          n.setAttribute("disabled", ""),
          n.setAttribute("data-disabled-by-htmx", "");
      }),
      t
    );
  }
  function removeRequestIndicators(e, t) {
    forEach(e.concat(t), function (n) {
      ...
      forEach(t, function (n) {
        getInternalData(n).requestCount === 0 &&
          (n.removeAttribute("disabled"), n.removeAttribute("data-disabled-by-htmx"));
      });
  }
  function haveSeenNode(e, t) {
    for (let n = 0; n < e.length; n++) if (e[n].isSameNode(t)) return !0;
    return !1;
  }
  ...
  function removeValueFromFormData(e, t, n) {
    if (e != null && t != null) {
      let r = n.getAll(e);
      Array.isArray(t) ? (r = r.filter((o) => t.indexOf(o) < 0)) : (r = r.filter((o) => o !== t)),
        n.delete(e),
        forEach(r, (o) => n.append(e, o));
    }
  }
  function getValueFromInput(e) {
    return e instanceof HTMLSelectElement && e.multiple
      ? toArray(e.querySelectorAll("option:checked")).map(function (t) {
          return t.value;
        })
      : e instanceof HTMLInputElement && e.files
        ? toArray(e.files)
        : e.value;
  }
  function processInputValue(e, t, n, r, o) {
    if (!(r == null || haveSeenNode(e, r))) {
      ...
      r instanceof HTMLFormElement &&
        (forEach(r.elements, function (i) {
          e.indexOf(i) >= 0 ? removeValueFromFormData(i.name, getValueFromInput(i), t) : e.push(i),
            o && validateElement(i, n);
        }),
  ...
  function validateElement(e, t) {
    ...
    n.willValidate &&
      ...
      n.checkValidity() ||
        (triggerEvent(n, "htmx:validation:failed", { message: n.validationMessage, validity: n.validity }) &&
          !t.length &&
  ...
  function getInputValues(e, t) {
    ...
    let a = (e instanceof HTMLFormElement && e.noValidate !== !0) || getAttributeValue(e, "hx-validate") === "true";
    if (
      (s.lastButtonClicked && (a = a && s.lastButtonClicked.formNoValidate !== !0),
      t !== "get" && processInputValue(n, o, i, getRelatedForm(e), a),
      processInputValue(n, r, i, e, a),
      s.lastButtonClicked ||
        e.tagName === "BUTTON" ||
        (e.tagName === "INPUT" && getRawAttribute(e, "type") === "submit"))
    ) {
      const u = s.lastButtonClicked || e,
        h = getRawAttribute(u, "name");
      addValueToFormData(h, u.value, o);
    }
    const l = findAttributeTargets(e, "hx-include");
    return (
      forEach(l, function (u) {
        processInputValue(n, r, i, asElement(u), a),
          matches(u, "form") ||
            forEach(asParentNode(u).querySelectorAll(INPUT_SELECTOR), function (h) {
              processInputValue(n, r, i, h, a);
            });
      }),
      overrideFormData(r, o),
      { errors: i, formData: r, values: formDataProxy(r) }
    );
  }
  ...
  function getHeaders(e, t, n) {
    ...
    return (
      getValuesForElement(e, "hx-headers", !1, r),
      n !== void 0 && (r["HX-Prompt"] = n),
      getInternalData(e).boosted && (r["HX-Boosted"] = "true"),
      r
    );
  }
  function filterValues(e, t) {
    ...
    if (n) {
      if (n === "none") return new FormData();
      if (n === "*") return e;
      if (n.indexOf("not ") === 0)
        return (
          forEach(n.slice(4).split(","), function (r) {
            (r = r.trim()), e.delete(r);
          }),
          e
        );
      {
        ...
        return (
          forEach(n.split(","), function (o) {
            (o = o.trim()),
              e.has(o) &&
                e.getAll(o).forEach(function (i) {
                  r.append(o, i);
                });
          }),
          r
  ...
  function getSwapSpecification(e, t) {
    ...
    if ((htmx.config.scrollIntoViewOnBoost && getInternalData(e).boosted && !isAnchorLink(e) && (r.show = "top"), n)) {
      ...
      if (s.length > 0)
        for (let a = 0; a < s.length; a++) {
          const l = s[a];
          if (l.indexOf("swap:") === 0) r.swapDelay = parseInterval(l.slice(5));
          else if (l.indexOf("settle:") === 0) r.settleDelay = parseInterval(l.slice(7));
          ...
          } else a == 0 ? (r.swapStyle = l) : logError("Unknown modifier in hx-swap: " + l);
        }
    }
    return r;
  }
  function usesFormData(e) {
    return (
      getClosestAttributeValue(e, "hx-encoding") === "multipart/form-data" ||
      (matches(e, "form") && getRawAttribute(e, "enctype") === "multipart/form-data")
    );
  }
  function encodeParamsForBody(e, t, n) {
    let r = null;
    return (
      withExtensions(t, function (o) {
  ...
  function updateScrollState(e, t) {
    ...
    if (t.scroll) {
      var o = null;
      t.scrollTarget && (o = asElement(querySelectorExt(n, t.scrollTarget))),
        t.scroll === "top" && (n || o) && ((o = o || n), (o.scrollTop = 0)),
        t.scroll === "bottom" && (r || o) && ((o = o || r), (o.scrollTop = o.scrollHeight)),
        typeof t.scroll == "number" &&
          getWindow().setTimeout(function () {
    ...
    if (t.show) {
      ...
      t.show === "top" &&
        (n || o) &&
        ((o = o || n), o.scrollIntoView({ block: "start", behavior: htmx.config.scrollBehavior })),
        t.show === "bottom" &&
          (r || o) &&
          ((o = o || r), o.scrollIntoView({ block: "end", behavior: htmx.config.scrollBehavior }));
    }
  }
  function getValuesForElement(e, t, n, r, o) {
    if ((r == null && (r = {}), e == null)) return r;
    ...
    if (i) {
      ...
      s.indexOf("javascript:") === 0
        ? ((s = s.slice(11)), (a = !0))
        : s.indexOf("js:") === 0 && ((s = s.slice(3)), (a = !0)),
        s.indexOf("{") !== 0 && (s = "{" + s + "}");
      let l;
      a
        ? (l = maybeEval(
        ...
        : (l = parseJSON(s));
      for (const u in l) l.hasOwnProperty(u) && r[u] == null && (r[u] = l[u]);
    }
  ...
  function ajaxHelper(e, t, n) {
    if (((e = e.toLowerCase()), n)) {
      if (n instanceof Element || typeof n == "string")
        return issueAjaxRequest(e, t, null, null, { targetOverride: resolveTarget(n) || DUMMY_ELT, returnPromise: !0 });
      {
        let r = resolveTarget(n.target);
        return (
          ((n.target && !r) || (n.source && !r && !resolveTarget(n.source))) && (r = DUMMY_ELT),
          issueAjaxRequest(e, t, resolveTarget(n.source), n.event, {
            handler: n.handler,
            headers: n.headers,
            values: n.values,
            targetOverride: r,
    ...
    } else return issueAjaxRequest(e, t, null, null, { returnPromise: !0 });
  }
  function hierarchyForElt(e) {
    const t = [];
    for (; e; ) t.push(e), (e = e.parentElement);
    return t;
  }
  function verifyPath(e, t, n) {
    const r = new URL(t, location.protocol !== "about:" ? location.href : window.origin),
      i = (location.protocol !== "about:" ? location.origin : window.origin) === r.origin;
    return htmx.config.selfRequestsOnly && !i
      ? !1
      : triggerEvent(e, "htmx:validateUrl", mergeObjects({ url: r, sameHost: i }, n));
  }
  function formDataFromObject(e) {
    ...
    for (const n in e)
      e.hasOwnProperty(n) &&
        (e[n] && typeof e[n].forEach == "function"
          ? e[n].forEach(function (r) {
              t.append(n, r);
            })
          : typeof e[n] == "object" && !(e[n] instanceof Blob)
  ...
  function formDataProxy(e) {
    return new Proxy(e, {
      get: function (t, n) {
        ...
        if (n === "toJSON") return () => Object.fromEntries(e);
        if (n in t && typeof t[n] == "function")
          return function () {
            return e[n].apply(e, arguments);
          };
        const r = e.getAll(n);
        if (r.length !== 0) return r.length === 1 ? r[0] : formDataArrayProxy(t, n, r);
      },
      set: function (t, n, r) {
        return typeof n != "string"
          ...
          : (t.delete(n),
            r && typeof r.forEach == "function"
              ...
              : typeof r == "object" && !(r instanceof Blob)
                ? t.append(n, JSON.stringify(r))
                : t.append(n, r),
            !0);
      },
  ...
  function issueAjaxRequest(e, t, n, r, o, i) {
    ...
    const u = o.handler || handleAjaxResponse,
      h = o.select || null;
    if (!bodyContains(n)) return maybeCall(s), l;
    const c = o.targetOverride || asElement(getTarget(n));
    if (c == null || c == DUMMY_ELT)
      return (
        triggerErrorEvent(n, "htmx:targetError", { target: getClosestAttributeValue(n, "hx-target") }), maybeCall(a), l
      );
    ...
    if (y) {
      ...
      if (b != null)
        if (VERBS.includes(b.toLowerCase())) e = b;
        else return maybeCall(s), l;
    }
    const d = getClosestAttributeValue(n, "hx-confirm");
    if (
      i === void 0 &&
      triggerEvent(n, "htmx:confirm", {
        target: c,
        elt: n,
        path: t,
        verb: e,
    ...
    let E = n,
      m = getClosestAttributeValue(n, "hx-sync"),
      C = null,
      w = !1;
    if (m) {
      const g = m.split(":"),
        b = g[0].trim();
      if (
        (b === "this" ? (E = findThisElement(n, "hx-sync")) : (E = asElement(querySelectorExt(n, b))),
        (m = (g[1] || "drop").trim()),
        (f = getInternalData(E)),
        m === "drop" && f.xhr && f.abortable !== !0)
      )
        return maybeCall(s), l;
      if (m === "abort") {
        if (f.xhr) return maybeCall(s), l;
        w = !0;
      } else
        m === "replace"
          ? triggerEvent(E, "htmx:abort")
          : m.indexOf("queue") === 0 && (C = (m.split(" ")[1] || "last").trim());
    }
    if (f.xhr)
      if (f.abortable) triggerEvent(E, "htmx:abort");
      else {
        if (C == null) {
          if (r) {
        ...
        return (
          f.queuedRequests == null && (f.queuedRequests = []),
          C === "first" && f.queuedRequests.length === 0
    ...
    const p = function () {
        (f.xhr = null),
          (f.abortable = !1),
          f.queuedRequests != null && f.queuedRequests.length > 0 && f.queuedRequests.shift()();
      },
      V = getClosestAttributeValue(n, "hx-prompt");
    if (V) {
      var P = prompt(V);
      if (P === null || !triggerEvent(n, "htmx:prompt", { prompt: P, target: c })) return maybeCall(s), p(), l;
    }
    if (d && !i && !confirm(d)) return maybeCall(s), p(), l;
    let T = getHeaders(n, c, P);
    e !== "get" && !usesFormData(n) && (T["Content-Type"] = "application/x-www-form-urlencoded"),
      o.headers && (T = mergeObjects(T, o.headers));
    const M = getInputValues(n, e);
    let D = M.errors;
    const B = M.formData;
    o.values && overrideFormData(B, formDataFromObject(o.values));
    const _ = formDataFromObject(getExpressionVars(n, r)),
      F = overrideFormData(B, _);
    let R = filterValues(F, n);
    htmx.config.getCacheBusterParam &&
      e === "get" &&
      R.set("org.htmx.cache-buster", getRawAttribute(c, "id") || "true"),
      (t == null || t === "") && (t = location.href);
    const q = getValuesForElement(n, "hx-request"),
      U = getInternalData(n).boosted;
    ...
    if (!triggerEvent(n, "htmx:configRequest", A)) return maybeCall(s), p(), l;
    if (
      ((t = A.path),
      (e = A.verb),
      (T = A.headers),
      (R = formDataFromObject(A.parameters)),
      (D = A.errors),
      (O = A.useUrlParams),
      D && D.length > 0)
    )
      return triggerEvent(n, "htmx:validation:halted", A), maybeCall(s), p(), l;
    const k = t.split("#"),
      W = k[0],
      N = k[1];
    let S = t;
    if (
      (O &&
        ((S = W),
        !R.keys().next().done &&
          (S.indexOf("?") < 0 ? (S += "?") : (S += "&"), (S += urlEncode(R)), N && (S += "#" + N))),
      !verifyPath(n, S, A))
    )
      return triggerErrorEvent(n, "htmx:invalidPath", A), maybeCall(a), p(), l;
    if (
      (x.open(e.toUpperCase(), S, !0),
    ...
    const v = {
      ...
      boosted: U,
      select: h,
      pathInfo: { requestPath: t, finalRequestPath: S, responsePath: null, anchor: N },
    };
    if (
      ((x.onload = function () {
        try {
          ...
          if (
            ((v.pathInfo.responsePath = getPathFromResponse(x)),
            u(n, v),
            v.keepIndicators !== !0 && removeRequestIndicators(I, L),
            triggerEvent(n, "htmx:afterRequest", v),
            triggerEvent(n, "htmx:afterOnLoad", v),
            !bodyContains(n))
          ) {
            let b = null;
      ...
      (x.onerror = function () {
        removeRequestIndicators(I, L),
          triggerErrorEvent(n, "htmx:afterRequest", v),
          triggerErrorEvent(n, "htmx:sendError", v),
          maybeCall(a),
          p();
      }),
      (x.onabort = function () {
        removeRequestIndicators(I, L),
          triggerErrorEvent(n, "htmx:afterRequest", v),
          triggerErrorEvent(n, "htmx:sendAbort", v),
          maybeCall(a),
          p();
      }),
      (x.ontimeout = function () {
        removeRequestIndicators(I, L),
          triggerErrorEvent(n, "htmx:afterRequest", v),
          triggerErrorEvent(n, "htmx:timeout", v),
          maybeCall(a),
          p();
      }),
      !triggerEvent(n, "htmx:beforeRequest", v))
    )
      return maybeCall(s), p(), l;
    var I = addRequestIndicatorClasses(n),
      L = disableElements(n);
    forEach(["loadstart", "loadend", "progress", "abort"], function (g) {
      forEach([x, x.upload], function (b) {
        b.addEventListener(g, function (H) {
          triggerEvent(n, "htmx:xhr:" + g, { lengthComputable: H.lengthComputable, loaded: H.loaded, total: H.total });
        });
      });
    }),
  ...
  function determineHistoryUpdates(e, t) {
    ...
    let r = null,
      o = null;
    if (
      (hasHeader(n, /HX-Push:/i)
        ? ((r = n.getResponseHeader("HX-Push")), (o = "push"))
        : hasHeader(n, /HX-Push-Url:/i)
          ? ((r = n.getResponseHeader("HX-Push-Url")), (o = "push"))
          : hasHeader(n, /HX-Replace-Url:/i) && ((r = n.getResponseHeader("HX-Replace-Url")), (o = "replace")),
      r)
    )
      return r === "false" ? {} : { type: o, path: r };
    const i = t.pathInfo.finalRequestPath,
      s = t.pathInfo.responsePath,
      a = t.etc.push || getClosestAttributeValue(e, "hx-push-url"),
      l = t.etc.replace || getClosestAttributeValue(e, "hx-replace-url"),
      u = getInternalData(e).boosted;
    let h = null,
      c = null;
    return (
      a ? ((h = "push"), (c = a)) : l ? ((h = "replace"), (c = l)) : u && ((h = "push"), (c = s || i)),
      c
        ? c === "false"
          ? {}
          : (c === "true" && (c = s || i),
            t.pathInfo.anchor && c.indexOf("#") === -1 && (c = c + "#" + t.pathInfo.anchor),
            { type: h, path: c })
        : {}
    );
  }
  ...
  function resolveResponseHandling(e) {
    for (var t = 0; t < htmx.config.responseHandling.length; t++) {
      ...
      if (codeMatches(n, e.status)) return n;
    }
    return { swap: !1 };
  }
  ...
  function resolveRetarget(e, t) {
    ...
    if (n == null) throw (triggerErrorEvent(e, "htmx:targetError", { target: t }), new Error(`Invalid re-target ${t}`));
    return n;
  }
  function handleAjaxResponse(e, t) {
    ...
    if ((hasHeader(n, /HX-Trigger:/i) && handleTriggerHeader(n, "HX-Trigger", e), hasHeader(n, /HX-Location:/i))) {
      ...
      var s = {};
      w.indexOf("{") === 0 && ((s = parseJSON(w)), (w = s.path), delete s.path),
        (s.push = s.push || "true"),
        ajaxHelper("get", w, s);
      return;
    }
    const a = hasHeader(n, /HX-Refresh:/i) && n.getResponseHeader("HX-Refresh") === "true";
    if (hasHeader(n, /HX-Redirect:/i)) {
      (t.keepIndicators = !0), (htmx.location.href = n.getResponseHeader("HX-Redirect")), a && htmx.location.reload();
      return;
    }
    if (a) {
    ...
    const l = determineHistoryUpdates(e, t),
      u = resolveResponseHandling(n),
      h = u.swap;
    let c = !!u.error,
      f = htmx.config.ignoreTitle || u.ignoreTitle,
      y = u.select;
    u.target && (t.target = resolveRetarget(e, u.target));
    var d = o.swapOverride;
    d == null && u.swapOverride && (d = u.swapOverride),
      hasHeader(n, /HX-Retarget:/i) && (t.target = resolveRetarget(e, n.getResponseHeader("HX-Retarget"))),
      hasHeader(n, /HX-Reswap:/i) && (d = n.getResponseHeader("HX-Reswap"));
    var E = n.response,
      m = mergeObjects(
        { shouldSwap: h, serverResponse: E, isError: c, ignoreTitle: f, selectOverride: y, swapOverride: d },
        t,
      );
    if (!(u.event && !triggerEvent(r, u.event, m)) && triggerEvent(r, "htmx:beforeSwap", m)) {
      if (
        ...
        n.status === 286 && cancelPolling(e),
          withExtensions(e, function (p) {
            E = p.transformResponse(E, n, e);
          }),
          l.type && saveCurrentPageToHistory();
        var C = getSwapSpecification(e, d);
        C.hasOwnProperty("ignoreTitle") || (C.ignoreTitle = f),
          r.classList.add(htmx.config.swappingClass),
          i && (y = i),
          hasHeader(n, /HX-Reselect:/i) && (y = n.getResponseHeader("HX-Reselect"));
        const w = o.selectOOB || getClosestAttributeValue(e, "hx-select-oob"),
          x = getClosestAttributeValue(e, "hx-select");
        swap(r, E, C, {
          ...
          beforeSwapCallback: function () {
            l.type &&
              (triggerEvent(getDocument().body, "htmx:beforeHistoryUpdate", mergeObjects({ history: l }, t)),
              l.type === "push"
                ? (pushUrlIntoHistory(l.path),
                  triggerEvent(getDocument().body, "htmx:pushedIntoHistory", { path: l.path }))
                : (replaceUrlInHistory(l.path),
                  triggerEvent(getDocument().body, "htmx:replacedInHistory", { path: l.path })));
          },
        });
      }
      c &&
        triggerErrorEvent(
          e,
          "htmx:responseError",
          mergeObjects({ error: "Response Status Error Code " + n.status + " from " + t.pathInfo.requestPath }, t),
        );
    }
  }
  const extensions = {};
  ...
  function getExtensions(e, t, n) {
    if ((t == null && (t = []), e == null)) return t;
    n == null && (n = []);
    const r = getAttributeValue(e, "hx-ext");
    return (
      r &&
        forEach(r.split(","), function (o) {
  ...
  function insertIndicatorStyles() {
    if (htmx.config.includeIndicatorStyles !== !1) {
      const e = htmx.config.inlineStyleNonce ? ` nonce="${htmx.config.inlineStyleNonce}"` : "",
        t = htmx.config.indicatorClass,
        n = htmx.config.requestClass;
  ...
  return (
    ready(function () {
      ...
      e.addEventListener("htmx:abort", function (r) {
        const o = r.detail.elt || r.target,
          i = getInternalData(o);
        i && i.xhr && i.xhr.abort();
      });
      const n = window.onpopstate ? window.onpopstate.bind(window) : null;
      (window.onpopstate = function (r) {
        r.state && r.state.htmx
          ? (restoreHistory(),
            forEach(t, function (o) {
              triggerEvent(o, "htmx:restored", { document: getDocument(), triggerEvent });
            }))
          : n && n(r);
      }),
        getWindow().setTimeout(function () {
...
document.addEventListener("htmx:afterSwap", (e) => {
  console.log("HTMX swapped content", e);
});
document.addEventListener("htmx:afterRequest", (e) => {
  console.log("HTMX completed request", e);
});
